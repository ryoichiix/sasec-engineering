...
export default function SupervisorTeam() {
  ...
  const [vehicles, setVehicles] = useState([])         // fleet, for batch equipment dropdowns
  ...
  // ── Fleet for batch equipment dropdowns (loaded once) ──
  useEffect(() => {
    let active = true
    ;(async () => {
  ...
  const saveAllBatches = async () => {
    ...
    try {
      ...
      const message = `${supervisorName} created ${saved} batch${saved === 1 ? '' : 'es'} for ${formatDate(date)}.`
                  ...
                  {batch.ot_planned && (
                    <div className="bg-amber-50 border border-amber-200 rounded-xl p-3">
                      ...
                      {['OT From', 'OT To'].map((label, i) => {
                        ...
                        const OT_TIMES = ['5:00 PM', '6:00 PM', '7:00 PM', '8:00 PM', '9:00 PM', '10:00 PM', '11:00 PM', '12:00 AM', '1:00 AM', '2:00 AM', '3:00 AM', '4:00 AM', '5:00 AM', '6:00 AM', '7:00 AM', '8:00 AM']
                        return (
